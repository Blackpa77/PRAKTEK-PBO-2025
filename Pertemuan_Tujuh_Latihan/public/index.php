...
$consoleLogger = new class implements Interfaces\Loggable {
...
$myLibrary = new Core\Library($consoleLogger);

// 2. Menambahkan item (Book dan Movie)
$book1 = new Models\Book("PHP OOP Mastery", "John Doe");
$movie1 = new Models\Movie("The Matrix", 1999);
...
echo "<p>" . $book1->getDetails() . " (Tipe: " . Models\Book::getMediaType() . ")</p>";
echo "<p>" . $movie1->getDetails() . " (Tipe: " . Models\Movie::getMediaType() . ")</p>";
